...
s.account = s_account;
s.visitor = Visitor.getInstance("41E27DA552A6473A0A490D4D@AdobeOrg");
var cdp="",brand
if(document.location.host.indexOf('thomson.co.uk')!=-1)
{
	cdp = 3;brand = "thomson"
}
if(document.location.host.indexOf('firstchoice.co.uk')!=-1)
{
	cdp = 3;brand = "firstchoice"
}
if(document.location.host.indexOf('falconholidays.ie')!=-1)
{
	cdp = 2;brand = "falconholidays"
}
/************************** CONFIG SECTION **************************/
...
s.linkInternalFilters="javascript:,firstchoice.co.uk,thomson.co.uk,falconholidays.ie"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"
s.cookieDomainPeriods = cdp
...
/*if(!s.pageName)
{
	...
	pageName = s.pageName.split('|');
	s.channel = pageName[0];
	s.prop1 = s.eVar1 = pageName[1];
}*/
...
//Internal Promotion
s.eVar5 = s.prop5 = s.Util.getQueryParam('vlid');

if(s.eVar5!="")
{
	s.eVar6=s.prop6=s.crossVisitParticipation(s.eVar5,'s_int_pro','30','5',' > ','','1');
}

// Search Term
s.eVar8 = s.prop8 = s.Util.getQueryParam('q');
...
if(s.eVar8!="")
{
	s.events = s.apl(s.events,"event1",",",1)
		...
		try
		{
		searc_no1 = document.getElementById('content').getElementsByTagName('font')[4].getElementsByTagName('b')[2].innerHTML
		}catch(err){}
		try
		{
		searc_no2 = document.getElementById('gm_search_separator_info').getElementsByTagName('b')[2].innerHTML
		}
		catch(err){}
		if(typeof searc_no1 != 'undefined')
		{
			s.eVar9 = s.prop9 = searc_no1;
		}
		else if(typeof searc_no2 != 'undefined')
		{
			s.eVar9 = s.prop9 = searc_no2;
		}
		else
		{
			s.eVar9 = s.prop9 = '0'
	...
	s.eVar59=s.prop59=s.crossVisitParticipation(s.eVar8,'s_sea_trm','90','5',' > ','','1');
}

s.prop31 = s.eVar31 = tpAh;
s.prop32 = s.eVar32 = tpA[2];
...
s.eVar33 = s.prop33 = s.getPreviousValue(s.pageName,'gpv_pn');
 
s.eVar34 = s.prop34 = s.getTimeToComplete(s.prop34,'ttc',0);

s.prop35 = s.eVar35 = s.getNewRepeat();

s.prop36 = s.eVar36 = s.getDaysSinceLastVisit('s_lv');

s.prop37 = s.eVar37 = s.getPercentPageViewed();

s.prop38 = s.eVar38 = document.location.host + document.location.pathname;

var url_split = document.URL.split('?')[1]
if(typeof url_split != 'undefined')
s.eVar39 = s.prop39 =  url_split;

s.eVar40 = s.prop40 = tmAm;

s.eVar41 = s.prop41="D=User-Agent";

if(typeof tui != 'undefined')
s.eVar42 = s.prop42 = tui.analytics.sessionID

//visitor ID - workbench cookie
s.eVar43 = s.prop43 = s.Util.cookieRead('v1st');

if(typeof visitor != 'undefined')
s.eVar44 = s.prop44 = visitor.getMarketingCloudVisitorID();

s.eVar47 = s.prop47 = document.location.protocol;

s.eVar48 = s.prop48 = brand; 

if(document.URL.indexOf('/destinations/packages')!=-1 || document.URL.indexOf('/flight/search')!=-1 || document.URL.indexOf('/cruise/packages')!=-1 || document.URL.indexOf('/holiday/packages')!=-1 || document.URL.indexOf('/f/packages')!=-1)
	{
		s.events = s.apl(s.events,"event1",",",1)
	}
	...
	if(document.URL.indexOf('/book/mobile/hubsummary')!=-1)
	{
		s.events = s.apl(s.events,"event16",",",1)
	}
	if(document.URL.indexOf('/destinations/book/flightoptions')!=-1 || document.URL.indexOf('/destinations/book/mobile/flightoptions')!=-1 || document.URL.indexOf('/holiday/book/flightoptions')!=-1 || document.URL.indexOf('/holiday/book/mobile/flightoptions')!=-1 || document.URL.indexOf('/f/book/flightoptions')!=-1 || document.URL.indexOf('/f/book/mobile/flightoptions')!=-1)
	{
		s.events = s.apl(s.events,"event17,scView,scOpen,scAdd",",",1)
	}	
	if(document.URL.indexOf('/destinations/book/roomoptions')!=-1 || document.URL.indexOf('/destinations/book/mobile/roomoptions')!=-1 || document.URL.indexOf('/holiday/book/roomoptions')!=-1 || document.URL.indexOf('/holiday/book/mobile/roomoptions')!=-1 || document.URL.indexOf('/f/book/roomoptions')!=-1 || document.URL.indexOf('/f/book/mobile/roomoptions')!=-1)
	{
		s.events = s.apl(s.events,"event18",",",1)
	}
	if(document.URL.indexOf('/destinations/book/extraoptions')!=-1 || document.URL.indexOf('/destinations/book/mobile/extraoptions')!=-1 || document.URL.indexOf('/holiday/book/extraoptions')!=-1 || document.URL.indexOf('/holiday/book/mobile/extraoptions')!=-1 || document.URL.indexOf('/f/book/extraoptions')!=-1 || document.URL.indexOf('/f/book/mobile/extraoptions')!=-1)
	{
		s.events = s.apl(s.events,"event19",",",1)
	}
	if(document.URL.indexOf('/destinations/book/passengerdetails')!=-1 || document.URL.indexOf('/destinations/book/mobile/passengerdetails')!=-1 || document.URL.indexOf('/holiday/book/passengerdetails')!=-1 || document.URL.indexOf('/holiday/book/mobile/passengerdetails')!=-1 || document.URL.indexOf('/f/book/passengerdetails')!=-1 || document.URL.indexOf('/f/book/mobile/passengerdetails')!=-1)
	{
		s.events = s.apl(s.events,"event20,scCheckout",",",1)
	}
	
	if(document.URL.indexOf('/cps/pageRender')!=-1)
	{
	
	if(s.Util.getQueryParam('b').indexOf('25000')!=-1 || s.Util.getQueryParam('b').indexOf('32000')!=-1 || s.Util.getQueryParam('b').indexOf('19000')!=-1 || s.Util.getQueryParam('b').indexOf('41000')!=-1 || s.Util.getQueryParam('b').indexOf('31000')!=-1 || s.Util.getQueryParam('b').indexOf('10000')!=-1 || s.Util.getQueryParam('b').indexOf('20000')!=-1 || s.Util.getQueryParam('b').indexOf('42000')!=-1 || s.Util.getQueryParam('b').indexOf('38000')!=-1)
	{
		...
		if(document.URL.indexOf('/destinations/book/confirmation')!=-1 || document.URL.indexOf('/destinations/book/mobile/confirmation')!=-1 || document.URL.indexOf('/holiday/book/confirmation')!=-1 || document.URL.indexOf('/holiday/book/mobile/confirmation')!=-1 || document.URL.indexOf('/f/book/confirmation')!=-1 || document.URL.indexOf('/f/book/mobile/confirmation')!=-1)
	{
		s.events = s.apl(s.events,"event22",",",1)
	}
	
	
	if(document.URL.indexOf('/cruise/bookitineraries')!=-1)
	{
		s.events = s.apl(s.events,"event23",",",1)
	}
	
		if(document.URL.indexOf('/cruise/packages/hotels')!=-1)
	{
		s.events = s.apl(s.events,"event24",",",1)
	}
	
		if(document.URL.indexOf('/cruise/bookHotelDetails')!=-1)
	{
		s.events = s.apl(s.events,"event25",",",1)
	}
	
		if(document.URL.indexOf('/cruise/book/cruiseoptions')!=-1)
	{
		s.events = s.apl(s.events,"event26,scView,scOpen,scAdd",",",1)
	}
	
		if(document.URL.indexOf('/cruise/book/flightoptions')!=-1)
	{
		s.events = s.apl(s.events,"event27",",",1)
	}
	
			if(document.URL.indexOf('/cruise/book/roomoptions')!=-1)
	{
		s.events = s.apl(s.events,"event28",",",1)
	}
	
			if(document.URL.indexOf('/cruise/book/extraoptions')!=-1)
	{
		s.events = s.apl(s.events,"event29",",",1)
	}
	
			if(document.URL.indexOf('/cruise/book/passengerdetails')!=-1)
	{
	...
	if(s.Util.getQueryParam('b').indexOf('37000')!=-1)
	{
		s.events = s.apl(s.events,"event31",",",1)
			...
			if(document.URL.indexOf('/cruise/book/confirmation')!=-1)
	{
		...
		if(document.URL.indexOf('/flight/book/flightoptions')!=-1 || document.URL.indexOf('/flight/book/mobile/flightoptions')!=-1)
	{
		s.events = s.apl(s.events,"event33,scView,scOpen,scAdd",",",1)
	}
	
		if(document.URL.indexOf('/flight/book/extraoptions')!=-1 || document.URL.indexOf('/flight/book/mobile/extraoptions')!=-1)
	{
		s.events = s.apl(s.events,"event34",",",1)
	}
	
			if(document.URL.indexOf('/flight/book/passengerdetails')!=-1 || document.URL.indexOf('/flight/book/mobile/passengerdetails')!=-1)
	{
	...
	if(s.Util.getQueryParam('b').indexOf('39000')!=-1 || s.Util.getQueryParam('b').indexOf('40000')!=-1)
	{
		s.events = s.apl(s.events,"event36",",",1)
			...
			if(document.URL.indexOf('/flight/book/confirmation')!=-1 || document.URL.indexOf('/flight/book/mobile/confirmation')!=-1)
	{
...
// Mobile device 	
s.eVar58 = s.prop58 = device_detection();

s.eVar74 = s.prop74 = Date.now();

    if (s.ActionDepthTest) {
      s.eVar75 = s.prop75 = s.getActionDepth("s_depth");
      s.eVar76 = s.prop76 = s.getActionDepthVisitor('s_depth_vis');
      s.ActionDepthTest = false;
    }
	
	//Time Stamp 

	s.eVar77 = s.prop77 = startTime();
...
isTablet  = function(){
    var ua = navigator.userAgent.toLowerCase();
    return ua.indexOf("tablet") > -1 ;
};
if(isIPhone()||isAndroidMobile() || isMobile())
	found = "Smartphone";
...
if(isIPad()||isAndroidTablet()||isTablet())
{
	...
	diag = Math.sqrt(Math.pow(screen.height,2) + Math.pow(screen.width,2))
	if(diag < 700)
	{
		found = "Mini Tablet";
	}
...
/*
   ...
   */
  s.getActionDepth = new Function("c", "" + "var s=this,v=1,t=new Date;t.setTime(t.getTime());" + "if(!s.c_r(c)){v=1}if(s.c_r(c)){v=s.c_r(c);v++}" + "if(!s.c_w(c,v,t)){s.c_w(c,v,0)}return v;");

  /*
   * Plugin: getActionDepth v1.0 - Returns the current
   * page number of the visit
   */
  s.getActionDepthVisitor = new Function("c", "" + "var s=this,v,t=new Date;t.setTime(t.getTime()+3600000);" + "if(!s.c_r(c)){v=1}if(s.c_r(c)){v=s.c_r(c);v++}" + "if(!s.c_w(c,v,t)){s.c_w(c,v,0)}return v;");
